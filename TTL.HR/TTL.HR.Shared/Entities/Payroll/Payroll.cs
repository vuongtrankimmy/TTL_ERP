...
namespace TTL.HR.Shared.Entities.Payroll
{
    ...
    {
        public string Name { get; set; } // Lương cơ bản, Phụ cấp xăng xe, BHXH...
        public string Code { get; set; } // SAL-BASE, ALL-FUEL...
    ...
    {
        public string Name { get; set; } // "Bảng lương Tháng 01/2026"
