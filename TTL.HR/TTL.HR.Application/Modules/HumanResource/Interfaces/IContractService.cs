...
namespace TTL.HR.Application.Modules.HumanResource.Interfaces
{
    ...
    {
        // Templates
        Task<PagedResult<ContractTemplateModel>> GetTemplatesAsync(int page = 1, int pageSize = 10, string? searchTerm = null, string? status = null, string? typeId = null, string? lang = null);
        ...
        // Employee Contracts
        Task<PagedResult<EmployeeContractModel>> GetEmployeeContractsAsync(int page = 1, int pageSize = 10, string? searchTerm = null, string? status = null, string? typeId = null, string? employeeId = null, string? lang = null);
