...
namespace TTL.HR.Application.Modules.Payroll.Interfaces
{
    public interface IPayrollService
    {
        ...
        Task<IEnumerable<PayrollPeriodModel>> GetPeriodsAsync(int? year = null);
        Task<PayrollPeriodDetailModel?> GetPeriodDetailAsync(string id, string? searchTerm = null, string? departmentId = null, int page = 1, int pageSize = 10);
